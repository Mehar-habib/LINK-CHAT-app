...
function MessageBar() {
  ...
  return (
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-6">
      ...
      <button
        className="bg-[#8417ff] hover:bg-[#741bda] focus:bg-[#741bda] rounded-md flex items-center justify-center p-5 focus:border-none focus:outline-none focus:text-white cursor-pointer"
